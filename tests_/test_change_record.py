...
def test_updateRecord(mocker):
    ...
    result = update_record(test_id, test_alias, test_first_name, test_last_name, test_email_address, test_employee_level, test_years_of_employee, test_in_the_AI2_program)
